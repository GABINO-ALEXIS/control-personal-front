    ...
    <main className="grid min-h-full min-w-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div className="text-center">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <Link
            to={redireccion}
            className="rounded-md bg-danger px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-primario focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            &larr; {bottomMessage}
          </Link>
        </div>
