...
export const SidebarTools = () => {
  ...
  return (
    ...
    >
      <div
        className={`flex size-9 items-center justify-center rounded-full bg-gris text-sm font-semibold text-negro`}
      >
        EV
      </div>
      <NavLink to="#">
        <IoNotificationsOutline
          className={`size-10 p-[0.5625rem] text-gris hover:rounded-2xl hover:bg-blanco hover:text-primario`}
        />
      </NavLink>
      <NavLink to="#">
